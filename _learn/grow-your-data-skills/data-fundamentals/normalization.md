...
The principles we'll cover in this lesson apply to relational database management systems (RDBMS). If you're using a NoSQL or [document-based database](/learn/grow-your-data-skills/data-landscape/types-of-databases) like MongoDB, the information below won't apply.
