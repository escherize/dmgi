...
ETL stands for [**E**xtract, **T**ransform and **L**oad](/learn/grow-your-data-skills/data-landscape/etl-landscape):
...
- [ETLs, ELTs, and reverse ETLs](/learn/grow-your-data-skills/data-landscape/etl-landscape)
...
- [Common data model mistakes made by startups](/learn/grow-your-data-skills/analytics/data-model-mistakes)

## Data storage layer

Once you've transformed the data, you need to put it somewhere that makes it easy to retrieve when you need it.

There are different [types of databases](/learn/grow-your-data-skills/data-landscape/types-of-databases), but for the purpose of a data stack we'll talk primarily about two broad categories of databases here: transactional and analytical.
...
- [Data warehouse vs data lake vs data mart](/learn/grow-your-data-skills/data-landscape/data-mart-data-warehouse-data-lake)
- [Types of databases](/learn/grow-your-data-skills/data-landscape/types-of-databases)
...
Some BI tools also include tools for modeling data and in some cases [writing back to your databases](/learn/metabase-basics/querying-and-dashboards/actions-crud) (that is, the allow you to create, update, or delete records), which opens up all kinds of possibilities for building back-office apps to work with your data.
