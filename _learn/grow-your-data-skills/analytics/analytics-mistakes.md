...
Most average-inspired delusions go away when you break the data out into a [histogram](/learn/metabase-basics/querying-and-dashboards/visualization/histograms). For example, rosy projections regarding the average cost of customer acquisition can disappear when you break the costs out by channel.
