...
You can create [models](/learn/metabase-basics/getting-started/models) to clean up messy raw data and make it easier for people to ask questions.
...
Insert [variables into your SQL](/docs/latest/questions/native-editor/sql-parameters) and Metabase will create a filter widget for you. Also: check out [field filters](/learn/metabase-basics/querying-and-dashboards/sql-in-metabase/field-filters) that create "smart" filters, with dropdown lists or date ranges.

![SQL template](../../images/next-steps/sql-template.png)

You can also save bits of SQL to reuse in other queries. Check out [Snippets](/learn/metabase-basics/querying-and-dashboards/sql-in-metabase/field-filters).
