...
Let's start with the obvious use case: if you know you want dashboards, have a bunch of KPIs, and enjoy getting updates on these metrics by email: Metabase is great at [pushing data](/learn/grow-your-data-skills/analytics/push-and-pull) throughout your organization.

**What to do**

- Figure out which tables of your database are relevant to non-engineers, and mark the remainder as hidden.
- Write descriptions of commonly used tables and any confusing fields to make it easier for people to [explore your data](/learn/metabase-basics/querying-and-dashboards/data-browser).
- Create a few [simple saved questions](/learn/metabase-basics/getting-started/ask-a-question) for frequently asked questions.
...
- Figure out the most common ways to find a given record, then tell people how to [use filters](/learn/metabase-basics/querying-and-dashboards/questions/searching-tables) to find specific records.
...
- Use your Metabase in an ad hoc fashion to [learn about your data](/learn/metabase-basics/querying-and-dashboards/data-browser).
...
If you're the only person in the office who knows SQL, you're probably fielding a lot of questions --- often the same ones over and over. Metabase works really well as a place to share SQL queries with non-technical users (or even just useful [snippets](/learn/metabase-basics/querying-and-dashboards/sql-in-metabase/snippets) of SQL). Metabase also provides a [friendly query building interface](/learn/metabase-basics/getting-started/ask-a-question) that allows people to ask their own questions without writing SQL.

**What to do**

- Create Metabase accounts for people.
- Start to collect common questions, and point people to the Metabase server.
- Look for opportunities for people to look up other people's common questions, and provide some [simple question templates](/learn/metabase-basics/querying-and-dashboards/sql-in-metabase/sql-variables) they can edit.
