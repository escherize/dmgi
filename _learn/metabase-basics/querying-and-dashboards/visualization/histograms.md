...
date: 2020-10-08 00:03:05
categories: jekyll update
author: The Metabase Team
image: /learn/images/visualizing-your-data-as-a-histogram/histogram.png
redirect_from:
...
Histograms are a type of [bar chart](/learn/metabase-basics/querying-and-dashboards/visualization/bar-charts). While the bars on a typical bar chart represent categorical groups, the bars on a histogram represent ranges along a continuous, quantifiable spectrum.
...
The histogram shows that customers are most likely to make purchases totaling in the \$40-60 range. If you hover over one of the bars, Metabase will display the count of orders in that range. You can also click on a bar to [drill-through the data](/learn/metabase-basics/querying-and-dashboards/questions/drill-through) and see the orders that compose the bar.

## Edit a histogram

Metabase gives you [a lot of knobs for customizing a bar chart](/learn/metabase-basics/querying-and-dashboards/visualization/bar-charts). For now, we'll hone in on the settings that make histograms shine.
...
Click the **Settings** > **Axes**. The x-axis scale currently says `Histogram`. Metabase detects when your [bar chart](/learn/metabase-basics/querying-and-dashboards/visualization/bar-charts) should present as a histogram, and selects the best x-axis scale for your visualization.
...
- [Visualization options](/docs/latest/questions/visualizations/visualizing-results)
- [Master the bar chart visualization](/learn/metabase-basics/querying-and-dashboards/visualization/bar-charts)
- [Drill-through charts with the action menu](/learn/metabase-basics/querying-and-dashboards/questions/drill-through)
