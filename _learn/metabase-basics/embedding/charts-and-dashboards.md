...
If you want to unlock the full potential of Metabase when embedding, which would allow people to drill through the data, or send them to [custom destinations](/docs/latest/dashboards/interactive#custom-destinations) like other dashboards or external URLS, you'll need interactive embedding. To learn more, see [Deliver analytics to your customers](/learn/metabase-basics/embedding/overview) and [Embed Metabase in your app to deliver multi-tenant, self-serving analytics](/learn/metabase-basics/embedding/multi-tenant-self-service-analytics).
