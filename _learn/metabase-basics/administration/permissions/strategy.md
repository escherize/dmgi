...
2. Within each group, figure out what [questions](/docs/latest/questions/introduction) and [dashboards](/docs/latest/dashboards/introduction) people need to see to do their jobs, and create them if you haven't already (or have them create their own stuff).
3. Identify what each group needs to have self-service access to, and make sure they can curate those [collections](/docs/latest/permissions/collections).
...
- [Data permissions](/docs/latest/permissions/data)
