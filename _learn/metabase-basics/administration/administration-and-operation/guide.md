...
- [Set Slack credentials](/docs/latest/configuring-metabase/slack)
- [Invite team members](/docs/latest/people-and-groups/managing)

### Curate your data

- [Hide irrelevant tables](/docs/latest/data-modeling/metadata-editing#table-visibility)
- [Organize questions](/docs/latest/permissions/collections)
...
Again, the most important things are to [add your databases](/docs/latest/databases/connecting) (or get someone else who has your database connection details to add them), [invite people to Metabase](/docs/latest/people-and-groups/managing), and ask them to [build some dashboards](/learn/metabase-basics/querying-and-dashboards/dashboards). Eventually you'll probably want to get [reports emailed out](/docs/latest/dashboards/subscriptions) and whatnot, but the main thing is to just get everyone onboard.
...
- [Guide to Permissions](/learn/metabase-basics/administration/permissions/index)
- [Permissions reference documentation](/docs/latest/permissions/introduction)
...
Alternatively, you can use a SQL query to [build a model](/learn/metabase-basics/getting-started/models), and let everyone use the query builder to slice and dice the data in that model.

## Annotate data with events

You can [add events](/docs/latest/exploration-and-organization/events-and-timelines) to collections to capture institutional knowledge: when you shipped important product updates, had a sale, ran an ad campaign, and so on. Events will show up on charts, so people will stop having to ask (again) why the data spiked back in April.
...
- To preload a Metabase with questions, dashboards, collections and so on, check out: [Serialization](/learn/metabase-basics/administration/administration-and-operation/serialization)
- For running Metabase in production, check out [Metabase at Scale](/learn/metabase-basics/administration/administration-and-operation/metabase-at-scale)
...
- To see how people are using your Metabase, check out [How to keep tabs on your data](/learn/metabase-basics/administration/permissions/keep-tabs-on-your-data)
- To program Metabase, check out [Working with the Metabase API](/learn/metabase-basics/administration/administration-and-operation/metabase-api)
