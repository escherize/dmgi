...
Learn more about [table visualizations](/learn/metabase-basics/querying-and-dashboards/visualization/table) and [exporting data](/docs/latest/questions/exporting-results).
