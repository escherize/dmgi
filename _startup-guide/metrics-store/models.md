...
This guide assumes you already have a database set up. If you don't have a database yet, you can quickly set one up using [Postgres](https://www.postgresql.org/docs/current/tutorial-createdb.html) or see our guide on the [different types of databases](/learn/grow-your-data-skills/data-landscape/types-of-databases) to decide on another.

You can use [ETL](/learn/grow-your-data-skills/data-landscape/etl-landscape) (extract, transform, load) tooling to move data from your application to your database. Here are a few recommendations to get started:
