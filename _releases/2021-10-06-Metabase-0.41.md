...
We're back with another big update to Metabase! If you're hosted on Metabase Cloud, we'll be rolling these new features automatically throughout this week. If you're self-hosting, you (or your administrator) can update to the latest version by following [the instructions here](/docs/latest/installation-and-operation/upgrading-metabase). Tired of manual updates? It's easy to [upgrade to a hosted plan](/upgrade/).
