...
We've polished [custom expressions](/learn/metabase-basics/querying-and-dashboards/questions/custom-expressions) to make it easier to ask more sophisticated questions. We've also included two new functions: `isempty` for checking for empty strings, and `isnull` for checking for null values.
