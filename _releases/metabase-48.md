...
[Metrics](/docs/latest/data-modeling/metrics) that you (or your admin) have defined for a table will now appear in X-rays to show you more of what you care about. The X-rays mechanism now also powers more helpful suggestions for aggregations and breakouts.
