...
With Heroku’s canceling of their free tier, Docker-based deployments and our own Metabase Cloud are now the easiest ways to deploy Metabase. With that, Heroku support is now deprecated, and will be removed in Metabase 0.46. To migrate off Heroku, see our guide on [Migrating from Heroku to Metabase Cloud](/docs/latest/cloud/migrate/heroku).
