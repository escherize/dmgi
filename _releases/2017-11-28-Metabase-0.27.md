...
You can download the new version of Metabase at [metabase.com/pricing](/pricing/). To upgrade, see the [instructions for your platform](/docs/latest/installation-and-operation/upgrading-metabase). As always, we _strongly_ recommend backing up your application database before upgrading.
