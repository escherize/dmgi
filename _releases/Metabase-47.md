...
- **If you’re self-hosting**, you (or your admin) can follow the docs on [how to upgrade](/docs/latest/installation-and-operation/upgrading-metabase).
...
To create, update, and delete dashboard cards in bulk, use `PUT /api/dashboard/:id/cards`. [More info in our documentation](/docs/latest/api).
