---
title:  "Metabase 0.25"
summary: "A new version of Metabase is out! Read Metabase 0.25 release notes."
...
You can [download the latest version here](/pricing/). If you're upgrading, [here are some instructions](/docs/latest/installation-and-operation/upgrading-metabase). As usual, we suggest backing up your data before you upgrade.
...
Getting Metabase set up inside your organization is now even easier. In addition to [Google Sign-in](/docs/latest/people-and-groups/google-sign-in) we now support [LDAP authentication](/docs/latest/people-and-groups/google-sign-in) so you can take your existing directory setup and enable Metabase logins for your organization without having to manually create accounts.
