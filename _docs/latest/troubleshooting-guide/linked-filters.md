...
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/troubleshooting-guide/linked-filters.md
layout: new-docs
latest: true
---
...
If you are having problems with a regular [filter widget][filter-widget-gloss], please see [this guide](./filters). In order to fix problems with linked filters, you need a clear understanding of how they work:
