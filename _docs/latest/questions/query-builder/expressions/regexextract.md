...
title: Regexextract
source_url: >-
  https://github.com/metabase/metabase/blob/master/docs/questions/query-builder/expressions/regexextract.md
layout: new-docs
latest: true
---
...
Now, you can use **Campaign Name** in places where you need clean labels, such as [filter dropdown menus](../../../dashboards/filters), [charts](../../visualizations/visualizing-results), and [embedding parameters](../../../embedding/static-embedding-parameters).
...
Use [substring](../expressions/substring) when you want to search text that has a consistent format (the same number of characters, and the same relative order of those characters).
