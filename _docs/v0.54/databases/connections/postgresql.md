...
category: Databases
title: PostgreSQL
source_url: 'https://github.com/metabase/metabase/blob/master/docs/databases/connections/postgresql.md'
layout: new-docs
redirect_from:
    - /docs/v0.54/administration-guide/databases/postgresql
---

# PostgreSQL

> This page covers connecting to PostgreSQL as a _data warehouse_. For using PostgreSQL as Metabase's _application database_, see [Configuring the Metabase application database](../../installation-and-operation/configuring-application-database).
