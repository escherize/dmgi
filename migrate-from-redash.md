...
You can also check out our homepage for [an overview of our features](/product/), or take a [Tour of Metabase](/learn/metabase-basics/overview/tour-of-metabase) to get some additional detail.

## Supported databases

Amazon Redshift, PostgreSQL, Big Query, Snowflake, MySQL, Mongo, and more: Metabase [supports a lot of databases out of the box](/docs/latest/databases/connecting#connecting-to-supported-databases), and there are a dozen [community drivers](/docs/latest/developers-guide/partner-and-community-drivers) to connect you to others.
...
- You can create [interactive dashboards](/docs/latest/dashboards/interactive) with [drill-through capabilities](/learn/metabase-basics/querying-and-dashboards/questions/drill-through), customizable click behaviors, and [cross filtering](/learn/metabase-basics/querying-and-dashboards/dashboards/cross-filtering).
...
Sharing a question or dashboard is as simple as sending someone a link (check out our [Guide to sharing data](/learn/metabase-basics/administration/administration-and-operation/guide-to-sharing-data)), and you can always export your results to a CSV, XLSX, or JSON file.
