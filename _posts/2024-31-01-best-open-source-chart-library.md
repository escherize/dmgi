...
- A [data browser](/learn/metabase-basics/querying-and-dashboards/data-browser) that can act as one centralized place for everyone to explore tables and fields; learn more about your data.
