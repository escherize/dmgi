...
If you’re interested in maps, check out [this guide](/docs/v0.54/questions/visualizations/map) — it covers everything you need to know about map visualization in Metabase.
...
- [Guide to maps](/docs/v0.54/questions/visualizations/map)
