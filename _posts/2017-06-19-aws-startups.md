...
summary: "Discover how AWS startups use Metabase for simple, scalable analytics without the complexity of traditional BI tools."
date: 2017-06-19 00:10:58
last_updated_at: 2017-06-19 00:10:58
categories: "Using Metabase"
author: Sameer Al-Sakran
image: /images/posts/aws-startups-&-metabase.jpg
layout: post
---
...
![Querying]({{ site.url }}/images/iterative.gif)
...
![SQL Templates]({{ site.url }}/images/sql_templates.gif)
...
![Dashboard filters]({{ site.url }}/images/dash_filters.gif)
...
Add your RDS and [Redshift Databases](/docs/latest/databases/connections/redshift), make some basic groups to control who gets access to which databases, and start inviting people.
