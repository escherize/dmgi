...
If Sneh could change one thing about their rollout, he probably would’ve more extensively worked out access groups, permissions, and role management, so that any new employee would automatically get the correct access to Metabase depending on their team and role. Metabase’s [LDAP integration](/docs/latest/people-and-groups/google-sign-in) makes this a snap.
