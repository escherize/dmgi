...
- [SQL variables](/docs/latest/users-guide/13-sql-parameters) (including [field filters](/learn/metabase-basics/querying-and-dashboards/sql-in-metabase/field-filters))
- [SQL snippets](/learn/metabase-basics/querying-and-dashboards/sql-in-metabase/snippets)
- [SQL snippet controls](/docs/latest/permissions/snippets) (available in [some plans](/pricing/))
