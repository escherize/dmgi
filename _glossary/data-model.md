---
title: Data model
summary: "Explore data models in Metabase to structure and organize your database for efficient querying and analysis."
headline: Data model
...
further-reading:
  - title: Models in Metabase
    url: /learn/metabase-basics/getting-started/models
  - title: Models documentation
    url: /docs/latest/data-modeling/models
  ...
  - title: Common data model mistakes made by startups
    url: /learn/grow-your-data-skills/analytics/data-model-mistakes
redirect_from:
  - /glossary/data_model
---
...
A [Metabase model](/learn/metabase-basics/getting-started/models) is a data model that you can create and save from a [question](/glossary/question) or SQL query.
...
If you're a Metabase admin, you'll have access to the [Data Model page](/docs/latest/data-modeling/metadata-editing) in Metabase. The changes you make here will affect the way that data appears across all of Metabase.
