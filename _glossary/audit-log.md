---
title: Audit log
summary: "Explore audit logs that track activity and performance in Metabase, available to admins on Pro and Enterprise plans."
headline: Audit log
...
key-article:
  ...
  url: /learn/metabase-basics/administration/permissions/keep-tabs-on-your-data
further-reading:
  ...
  - title: Managing people in Metabase
    url: /learn/metabase-basics/administration/administration-and-operation/managing-people
redirect_from:
  - /glossary/audit_log
---
...
The charts show which questions are most popular and which take the longest to load; identifying which questions and dashboards are slowest to load can help inform changes that you may want to make, like adjusting your [cache settings](/docs/latest/configuring-metabase/caching) or [optimizing SQL queries](/learn/grow-your-data-skills/learn-sql/working-with-sql/sql-best-practices).
