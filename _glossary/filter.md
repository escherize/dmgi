---
title: Filter
summary: "Explore filters in Metabase to narrow down data results by applying conditions to questions and dashboards."
headline: Filter
...
further-reading:
  ...
  - title: Getting started with Metabase
    url: /learn/metabase-basics/getting-started/ask-a-question
  - title: Adding filters to dashboards with SQL questions
    url: /learn/metabase-basics/querying-and-dashboards/sql-in-metabase/filters
  ...
  - title: "Cross-filtering: using a chart to update a dashboard filter"
    url: /learn/metabase-basics/querying-and-dashboards/dashboards/cross-filtering
---
...
- Set up [cross-filtering](/learn/metabase-basics/querying-and-dashboards/dashboards/cross-filtering) so dashboard filters update when someone clicks on a [card](/glossary/card).
