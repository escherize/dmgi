---
title: Card
summary: "Learn about cards in Metabase dashboards, which display data or text and can be customized to enhance your visualizations."
headline: Card
...
further-reading:
  - title: Building dashboards track
    url: /learn/metabase-basics/querying-and-dashboards/dashboards
  ...
  - title: Working with the Metabase API
    url: /learn/metabase-basics/administration/administration-and-operation/metabase-api
---
...
- Connect cards to [dashboard filters](/docs/latest/dashboards/filters) to filter the question's results.
...
In the [Metabase API](/learn/metabase-basics/administration/administration-and-operation/metabase-api), the [`api/card`](/docs/latest/api#tag/apicard) route refers to questions, rather than cards on a dashboard.
