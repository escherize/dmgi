...
1. Start from the [data browser](/learn/metabase-basics/getting-started/find-data). Add [filters](/glossary/filter) and summarizations using the sidebars to the right of your data visualization.
