...
In the [Metabase API](/learn/metabase-basics/administration/administration-and-operation/metabase-api), you can edit and get information about questions in your Metabase instance using the [`api/card`](/docs/latest/api#tag/apicard) route.
