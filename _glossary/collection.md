---
title: "Collection"
summary: "Learn about collections in Metabase, used to organize questions, dashboards, and models for easy access and collaboration."
headline: "Collection"
...
key-article:
  ...
  url: /docs/latest/exploration-and-organization/collections
further-reading:
  - title: Working with collection permissions
    url: /learn/metabase-basics/administration/permissions/collection-permissions
...
Administrators can set [collection permissions](/docs/latest/permissions/collections) to determine which collections (and by extension, their contents) are viewable by which groups in Metabase.
