...
summary: "Understand data dictionaries as repositories for metadata that describe database tables, fields, and their meaning."
...
further-reading:
  - title: "Exploring data with Metabase's data browser"
    url: /learn/metabase-basics/querying-and-dashboards/data-browser
  - title: "Data reference documentation"
    url: /docs/latest/exploration-and-organization/data-model-reference
redirect_from:
