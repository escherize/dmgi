...
Metabase's [Sample Database](/glossary/sample_database) (the one you see used in examples throughout our [docs](/docs/latest/) and [tutorials](/learn/)) is an [H2](/docs/latest/databases/connecting) relational database. Figure 1 shows a look at the four tables in the Sample Database:
