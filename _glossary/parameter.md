...
further-reading:
  ...
  - title: "Dashboard filters"
    url: /docs/latest/dashboards/filters
...
When [embedding](/docs/latest/embedding/introduction) Metabase questions and dashboards in your app, you can set parameters to customize what different users see when viewing those embeds.
