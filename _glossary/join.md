---
title: Join
summary: "Learn about joins in SQL, which combine data from multiple tables based on related columns."
headline: Join
...
further-reading:
  ...
  - title: Types of SQL joins
    url: /learn/grow-your-data-skills/learn-sql/working-with-sql/sql-join-types
  - title: Documentation on joining data
    url: /docs/latest/questions/query-builder/join
---
...
There are four [types of SQL joins](/learn/grow-your-data-skills/learn-sql/working-with-sql/sql-join-types):
