...
- Leverage on Metabase [filter widgets](/learn/metabase-basics/querying-and-dashboards/sql-in-metabase/sql-variables){:target="_blank"} and [date filters](/docs/latest/dashboards/filters){:target="_blank"} to create interactive dashboards for stakeholders to slice and dice;
