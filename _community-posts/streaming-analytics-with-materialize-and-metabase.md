...
meta_description: How to build an end-to-end streaming analytics pipeline using Metabase, Materialize.
date:   2025-02-12 18:10:58
...
Taking the leap from batch to streaming will never not be challenging, but it can sure enough be less painful. As the [Modern Data Stack (MDS)](/blog/the-modern-data-stack) reshapes the future of data engineering and analytics, there are some tools focusing on lowering the entry barrier to the space by providing:
