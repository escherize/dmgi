...
The easiest way to funnel the creation of the resources (questions, dashboards, alerts) in their appropriate location, is [to set up and manage permissions thus avoiding any users errors](/docs/latest/permissions/introduction).
