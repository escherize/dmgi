...
We know many of you were disappointed by the announcement that Chartio will be going away, and are looking for a new home for your charts and dashboards. So we wanted to provide this brief overview to help you decide if Metabase would be a good replacement for you. The fastest way to get to know Metabase is to [download it and try it out](/pricing/), or to [start a free Metabase Cloud trial](/pricing/). You can quickly and easily connect to your own data, or just play around the with Sample Dataset included with Metabase.
...
Amazon Redshift, PostgreSQL, Big Query, Snowflake, MySQL, Mongo, and more: Metabase has a bunch of [officially supported databases](/docs/latest/databases/connecting), as well as a dozen [community drivers](/docs/latest/developers-guide/partner-and-community-drivers).
...
- A graphical query builder that's [simple to pick up](/learn/metabase-basics/getting-started/ask-a-question), with separate modes for beginners and experts. You can add custom columns and use [custom expressions](/learn/metabase-basics/querying-and-dashboards/questions/custom-expressions) for your filters and aggregations, and even join data, without having to write any SQL.
...
Once you have the results you're looking for, you'll have [more than 15 different visualizations](/docs/latest/questions/visualizations/visualizing-results) to choose from, including pivot tables, gauges, time series with trend lines, maps, and numbers with percent changes. Check out our [visualizations guide](/learn/metabase-basics/querying-and-dashboards/visualization/chart-guide) for more details.

### Dashboards

A dashboard is way more than a collection of charts in Metabase.

- You can create [interactive dashboards](/docs/latest/dashboards/interactive) with [drill-through capabilities](/learn/metabase-basics/querying-and-dashboards/questions/drill-through), [customizable click behaviors](/docs/latest/dashboards/interactive#customizing-click-behavior), and [cross filtering](/learn/metabase-basics/querying-and-dashboards/dashboards/cross-filtering).
- Speaking of filters, Metabase lets you add [smart filter widgets](/learn/metabase-basics/querying-and-dashboards/sql-in-metabase/field-filters) to your dashboards that allow anyone to explore and modify the SQL-based charts in your dashboard.
...
Sharing a question or dashboard is as simple as sending someone a link (check out our [Guide to sharing data](/learn/metabase-basics/administration/administration-and-operation/guide-to-sharing-data)). Or, you can always export your results to a CSV, XLSX, or JSON file.
...
If you've made it this far, it's probably time to [spin up your own Metabase](/pricing/) and kick the tires. But if you still have questions, feel free to [start a chat with us](/pricing/), [post on the community forum](https://discourse.metabase.com/t/migrating-from-chartio-to-metabase/14609), or [use our contact form](/help/).
